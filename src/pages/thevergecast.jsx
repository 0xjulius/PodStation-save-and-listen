...
function TheVergeCastFeed() {
  ...
  return (
    <div className="bg-verge text-black min-h-screen flex flex-col p-6 font-sans">
      <header className="sticky top-0 bg-black bg-opacity-90 backdrop-blur-md p-4 rounded-b-xl z-20 mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center">
            <motion.img
              src="https://megaphone.imgix.net/podcasts/e4c412e6-e1f0-11e8-9bde-83f9d376f059/image/Podcast_Tile_6000x6000px.png?ixlib=rails-4.3.1&max-w=300&max-h=300&fit=crop&auto=format,compress"
              alt="Logo"
              className="rounded mr-4 block"
              animate={{
            ...
            />
            <h1 className="pl-4 text-xl font-bold select-none lg:text-3xl text-white">
              <span className="text-yellow-300">The </span>Vergecast
            </h1>
          </div>
      ...
      <HeaderInfo
        className="mb-6"
        title="Welcome to The Vergecast"
        subtitle="A podcast about the week in tech, hosted by Nilay Patel, Paul Miller, and Tom Warren."
      />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {(loading || filteredEpisodes.length === 0) && !showFavoritesOnly
                ...
                : visibleEpisodes.map((ep, index) => (
                    ...
                    >
                      <img
                        src="https://megaphone.imgix.net/podcasts/e4c412e6-e1f0-11e8-9bde-83f9d376f059/image/Podcast_Tile_6000x6000px.png?ixlib=rails-4.3.1&max-w=3000&max-h=3000&fit=crop&auto=format,compress"
                        alt={ep.title}
...
export default TheVergeCastFeed;
