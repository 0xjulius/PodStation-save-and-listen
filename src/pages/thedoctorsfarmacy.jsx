...
function TheDoctorsFarmacy() {
  ...
  return (
    <div className="lb-body text-black min-h-screen flex flex-col p-6 font-sans">
      <header className="sticky top-0 bg-black bg-opacity-90 backdrop-blur-md p-4 rounded-b-xl z-20 mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center">
            <motion.img
              src="https://megaphone.imgix.net/podcasts/023e032e-c763-11ee-be4f-27c14bd0edec/image/b48241079d9f8d935c35e92fa507926f.jpg?ixlib=rails-4.3.1&max-w=300&max-h=300&fit=crop&auto=format,compress"
              alt="Logo"
            ...
            />
            <h1 className="pl-4 text-xl font-bold select-none lg:text-3xl text-yellow-300">
              THE DR. HYMAN SHOW
            </h1>
          </div>
      ...
      <HeaderInfo
        className="mb-6 "
        title="Welcome to The Doctor's Farmacy"
        subtitle="Join Dr. Mark Hyman as he explores the intersection of health, food, and sustainability with leading experts in the field."
      />
                ...
                : visibleEpisodes.map((ep, index) => (
                    ...
                    >
                      <img
                        src={
                          ep.image ||
                          "https://megaphone.imgix.net/podcasts/023e032e-c763-11ee-be4f-27c14bd0edec/image/b48241079d9f8d935c35e92fa507926f.jpg?ixlib=rails-4.3.1&max-w=3000&max-h=3000&fit=crop&auto=format,compress"
                        }
                        alt={ep.title}
...
export default TheDoctorsFarmacy;
